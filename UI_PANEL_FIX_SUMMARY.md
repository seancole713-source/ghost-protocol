...
### 7. Circuit Breakers / Controls Bar
...
### 1. Manual Watchlist - [object Object] Bug
...
### 3. APEX Trade Card - AI Explainability
...
5. **Trigger AI inference to populate analogs**:
...
- **Server Health**: ✅ OK (http://localhost:5000/health)
...
- [ ] **FIX: Risk Status endpoint**
- [ ] **FIX: Trade Card yfinance fallback**
- [ ] Trigger AI inference for analog data
- [ ] Switch to LIVE mode Monday 8:00 AM
- [ ] Update real WOLF position
- [ ] Verify all UI panels render correctly

**Status**: 🟡 **READY FOR TESTING** (2 critical fixes pending)
