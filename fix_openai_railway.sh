...
echo ""
echo "Option 3 - Using Railway API (if you have an API token):"
echo "  curl -X POST https://backboard.railway.app/graphql \\"
echo "    -H 'Authorization: Bearer YOUR_RAILWAY_TOKEN' \\"
echo "    -H 'Content-Type: application/json' \\"
echo "    -d '{\"query\":\"mutation { variableUpsert(input: {projectId: \\\"YOUR_PROJECT_ID\\\", environmentId: \\\"YOUR_ENV_ID\\\", name: \\\"OPENAI_AGENT_API_KEY\\\", value: \\\"'$OPENAI_KEY'\\\"}) { id }}\"}"
echo ""
