...
(`AI_MEMORY`) capped at 100 entries; manual pruning |
...
-**Phase 0 (Now)**1. Integrate `core/ai_memory.AIMemory` into `wolf_app.py` (persisted recall, semantic
...
-**Phase 2**1. Expand multi-asset intelligence, correlation matrix, hedging suggestions.
