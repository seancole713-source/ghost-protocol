...
- [x] **Backend Infrastructure**- [x] Grid generation implemented (`_generate_forecast_grid`)
...
- [x]**API Endpoints**- [x] `/api/cockpit` returns `two_line_overlay` field
  - [x] `/api/cockpit/stream` SSE endpoint implemented
  - [x] `/api/forecast/overlay` legacy endpoint (backward compat)

- [x]**Frontend Visualization**- [x] `normalizeOverlay()` parses two_line_overlay schema
...
- [ ] **Chart Rendering**- [ ] Ghost forecast line visible (solid blue #5bd4ff, 2.5px width)
...
- [ ]**Accuracy Metrics**- [ ] MAP chip displays percentage (e.g., "MAP: 0.15%")
...
- [ ]**Metadata**- [ ] Coverage shows hours (e.g., "Coverage: 48h")
