...
2. **`forecast_full` in cockpit** - Line ~12170

   - `"label": "Stock Predictions"` → `"label": "Ghost Predictions"`

3. **`/api/forecast/overlay` endpoint** - Line ~9970
...
**Total Changes:** 4 label replacements\
**Files Modified:** 1 (wolf_app.py)\
**Deployment:** Triggered automatically via Railway
