...
### 1. core/agent_analytics.py (2 errors fixed)

**Issue**: Optional member access on potentially None datetime
...
2. **Line 114**: Added `# type: ignore[arg-type]` for intentional None argument test
3. **Line 135**: Added `# type: ignore[arg-type]` for intentional string argument test
