...
1. ✅ Telegram webhook **IS working**2. ❌ AI agent**is NOT enabled yet**
...
### "Commands: /status, /signal, /pnl"**Solution:**AI not enabled yet (same as above)

### "OpenAI API error"**Solution:**Check your API key is valid and has credits

### Telegram not receiving messages**Solution:**Check webhook is set
...
1. **Text Ghost**: "What would a Bitcoin drop do to WOLF?"
2. **Get AI analysis**: Ghost responds with market insights!
...
## Example Session**You:**What would a Bitcoin drop do to WOLF?**Ghost:**🤔 Thinking...**Ghost:**🤖 Ghost
...
1. **Your Position**: Currently holding [X] shares @ $[Y]. If BTC triggers broad


   selloff, WOLF could see 3-5% pullback

1. **Current Signal**: [BUY/HOLD/SELL] with [XX]% confidence
2. **Recommendation**: Monitor NASDAQ more than Bitcoin. Set stop-loss if BTC drops
