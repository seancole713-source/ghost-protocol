...
2. Find port**5000**3. Right-click →**Port Visibility**→**Public**4. The URL will now work without auth!
...
4. Access Ghost UI at: `https://[your-url]/`**No authentication required, works from any browser!**______________________________________________________________________


## ✅ QUICK ACCESS NOW**Option A**: Make port 5000 public in PORTS tab\
