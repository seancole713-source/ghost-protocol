...
5. 📋 **Hunter Core Framework** - Scanner/ranker architecture (blueprint ready)
...
### 2. Feature Diagnostics (`core/feature_diagnostics.py`)

**Purpose**: Instrument feature extraction pipeline with visibility
