...
The Ghost Movers Scanner detects significant price movements in both crypto and stock markets, sending timely Telegram alerts for actionable opportunities. It enforces strict live pricing requirements and provides comprehensive health monitoring.
...
Returns scanner health and statistics.
