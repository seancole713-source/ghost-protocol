...
**Historical OHLCV**:
- ❌ **NOT IMPLEMENTED**
- Current: Falls back to Yahoo (doesn't have crypto)
...
### 1. Yahoo Finance Rate Limiting (CRITICAL)
**Symptoms**:
```
