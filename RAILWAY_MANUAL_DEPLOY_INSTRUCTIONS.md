...
1. **Go to Railway Dashboard**
   ...
   - Project: **tender-benevolence**
   - Service: **web**

2. **Navigate to Settings**

   - Click **Settings** tab (not Deployments)
   - Scroll to **GitHub Repo**
   - Current: `seancole713-source/GHOST` on branch `main`

3. **Disconnect & Reconnect GitHub**
...
4. **Trigger New Deployment**
   ...
   - This should automatically start a new deployment
...
1. **Go to Deployments Tab**
   ...
   - Click **Deployments**
   - You'll see list of past deployments

2. **Look for Commit `f03e4b4`**

   - Look for: "feat: add UI alias endpoints for missing panels"
...
1. **Make a tiny change to force webhook**
...
2. **Wait 30 seconds**, then check Railway dashboard
...
- ✅ Total routes: **263** (not 231)
- ✅ News endpoints: **3+**
- ✅ Alias endpoints: **3** (decide, sources/status, market/movers)
