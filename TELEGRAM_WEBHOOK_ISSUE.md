...
**Note:** ngrok URL changes each time unless you have a paid account.
...
> A drop in Bitcoin may not have a direct impact on Wolfspeed (WOLF) stock, but it could
...
4. **Text your bot**: "What would a Bitcoin drop do to WOLF?"
