...
### **Crypto (20 Core)**
- **Majors**: BTC, ETH, SOL, XRP, ADA, DOGE, MATIC, AVAX
- **DeFi**: UNI, AAVE, LINK, CRV
- **Memes**: SHIB, PEPE, FLOKI, BONK

### **VIP Coins (High-Risk Tracking)**
- WEPE, LILPEPE, DORKL, SLOTH, APC, TURBO, WOJAK

**Total Universe**: 50+ assets tracked 24/7
...
- **Horizon**: 24-48 hours
- **Primary Validation Ticker**: **SPY**
- **Secondary**: AAPL, BTC, ETH
...
6. ✅ **MEASURABLE ACCURACY** - Track and report every prediction outcome
...
- **Stocks**: 2-5 years daily OHLCV minimum
...
- **Prices**: Update every 60s (stocks), 30s (crypto)
...
### **Required (Production)**
- ✅ `POLYGON_API_KEY` - Primary stock data
...
- `BINANCE_API_KEY` - Crypto volume/orderbook
