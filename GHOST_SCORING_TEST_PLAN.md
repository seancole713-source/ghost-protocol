...
railway run sqlite3 data/wolf.db "SELECT confidence, correct, checked FROM ghost_predictions ORDER BY predicted_at DESC LIMIT 10;"
...
### Scenario 1: Telegram Commands Fail

**Symptoms**: `/predict` or `/check` returns error
