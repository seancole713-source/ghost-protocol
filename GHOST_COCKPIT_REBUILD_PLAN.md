...
### 🔄 PANELS TO REBUILD
10. **Ghost Score Heatmap (GPS 0–10)** (line 542) - Single WOLF heatmap → Multi-asset
11. **Top Movers** (needs expansion to 4000+ stocks)
12. **Personal Portfolio** (needs multi-asset support)
13. **News Feed** (currently disabled - reuters_feeds_off)

### ❌ PANELS TO REMOVE
14. **⚡ Smart Execution** (line 495) - Always shows zeros, not active
15. **Diagnostics** (line 551) - Merge into Health panel
16. **⏱ Provider Backoff** (standalone) - Merge into Provider Health Matrix
...
### Step 2: ROW 0 - Header Implementation
**Files**: `cockpit_v2.html`
...
10. ⏳ Extract JS → `cockpit_v2.js`
11. ⏳ Add route in `wolf_app.py`
12. ⏳ Test & validate
