...
| ✅ Stale data indicators visible | ⚠️ **PARTIAL** | P2 | `_degraded` field not always rendered |
...
| ✅ Degraded mode indicator | ❌ **MISSING** | P2 | When cached news shown, no indicator |
...
| ✅ UI shows persistence status | ❌ **MISSING** | P2 | No indicator of save state |
...
| ✅ Message delivery failures logged | ⚠️ **UNKNOWN** | P2 | Check logs for errors |
...
| ✅ Add symbol to watchlist works | ⚠️ **UNKNOWN** | P1 | Test via UI |
...
| ✅ Config toggles accessible | ⚠️ **UNKNOWN** | P1 | Runtime flags for feeds/alerts/etc |
...
| ✅ Audit log accessible | ❌ **MISSING** | P3 | View recent admin actions |
...
| ✅ Overdraft prevented | ⚠️ **UNKNOWN** | P1 | Cannot withdraw more than cash |
...
| ✅ Date range selector | ⚠️ **UNKNOWN** | P3 | Filter by year/month |
...
| ✅ No console errors | ⚠️ **UNKNOWN** | P1 | Check browser dev console |
...
| ✅ Focus indicators visible | ⚠️ **UNKNOWN** | P2 | Tab → verify focus ring |
...
| ✅ Error details sent to logs | ⚠️ **UNKNOWN** | P2 | Check Railway logs for JS errors |
...
| ✅ Edge (latest) | ⚠️ **UNKNOWN** | P2 | Test version 118+ |
