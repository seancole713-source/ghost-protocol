...
Portfolio, DB, cache | | **Price Providers** | Live data, API keys, fallbacks | |
**Telegram Bot** | Bot status, webhook, endpoint | | **Security** | All API keys/secrets
...
# 2. Add to crontab
(crontab -l 2>/dev/null; echo "0 9 * * * source /etc/ghost/audit.env && /workspaces/GHOST/ghost_daily_audit.sh") | crontab -
