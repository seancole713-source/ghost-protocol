...
Server will be available at: **[http://localhost:5000](<<<<<http://localhost:500>>>>>0)**______________________________________________________________________
...
1. Navigate to**[http://localhost:5000/cockpit](<<<<<http://localhost:5000/cockpi>>>>>t)**2. Click "Import Positions"
2. Paste CSV or JSON
3. Click "Apply"**CSV Format**:
...
Open in browser: **[http://localhost:5000/cockpit](<<<<<http://localhost:5000/cockpi>>>>>t)**### Key Panels

1.**Portfolio Overview**- Live NAV, PnL, positions

   - Real-time price updates
   - Market value calculations


1.**Forecast Overlay (48h)**- Predicted vs actual price lines

   - MAP, RMSE, Bias metrics
   - Auto-pause on anomalies


1.**Diagnostics**- Provider status
...
1.**Admin Toggles**- Live config changes
...
2. Check provider circuit breakers
